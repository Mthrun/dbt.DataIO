...
#                                   Note: Make this a  3 dimensional array through ListAsEsomNeurons (ListAsWts)
...
#
# OPTIONAL
# OutDirectory                     directory to write into, default = current dir
...
#                                  default: x<Line<y<Col>t<VarNumber>
#

# author: FL/MT 07/2015 # comment changed ALU 2021
